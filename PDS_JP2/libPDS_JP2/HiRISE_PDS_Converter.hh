...
HiROC CVS ID: HiRISE_PDS_Converter.hh,v 1.20 2009/10/01 06:06:44 castalia Exp
...
#ifndef _HiRISE_PDS_Converter_
#define _HiRISE_PDS_Converter_
...
*/
explicit HiRISE_PDS_Converter (const std::string& pathname,
